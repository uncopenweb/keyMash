dojo.provide('profile.ProfileEditor');

dojo.require('dijit._Widget');
dojo.require('dijit._Templated');

dojo.declare('profile.ProfileEditor', [ dijit._Widget, dijit._Templated ], {
    templatePath: dojo.moduleUrl("profile", "ProfileEditor.html"),
